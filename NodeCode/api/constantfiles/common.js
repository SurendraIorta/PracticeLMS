...
var commonObj  =   {
   ...
   LeadType  :   [
    ...
    lead_disposition:[
       "Need Analysis/Proposal",
       "Post selling Visit/Reference Request",
       "Not Interested",
       "Irated Customer",
       "Follow up",
       "Renewal collected/Follow up",
       "Service Update"
    ],
    LeadDispForNotInt:[
       {
       ...
       {
          "LA_CODE":"CSADGA",
          "Description":"Client Straight away denies giving appointment"
       }
    ],
    LeadDispForNotAvailable:[
       {
          "LA_CODE":"FPNNR",
          "Description":"Phone Number not reachable"
       },
       {
          "LA_CODE":"PNSO",
          "Description":"Phone Number switched off"
       },
       {
          "LA_CODE":"PNNA",
          "Description":"Phone Number not answer"
       }
    ],
    LeadDispForWrongNumber:[
       {
          "LA_CODE":"WN",
          "Description":"Wrong Number"
       }
    ...
    Campaign:[
       ...
       "Diwali Mela",
       "Maturity",
       "Maturity - Pre-Fixed Appointment",
       "Survival Benefit",
       "Survival Benefit - Pre-Fixed Appointment",
       "My Leads - GOLDMINE",
       "Pre-Approved Offer - Pre-Fixed Appointment",
       "Pre-Approved Offer",
       "Positive Fund Value",
       "Employee – Employer",
       "HUF",
    ...
    lead_dis_notMet:[
       ...
       "Client straight away denied giving appointment",
       "Phone Number not reachable/switched off / no answer",
       "Wrong Number"
    ],     
    CallDispo:[
       {
    ...
    ContactableSubTypeList:[
       "Appointment",
       "Not Interested",
       "Call Back",
       "Non Servicable Location"
    ],
    NonContactableSubTypeList:[
       "Ringing",
       "Wrong Number",
       "Not Reachable",
       "Busy",
       "Short HangUp",
       "Renewal-Collectable",
       "Renewal-NotCollectable"
    ],
    YesNoOption:[{"option":"Yes"},{"option":"No"}],
    reasonForNoPolicyOptions	:	[{
       "type": "Financial Issue"
   }, {
       "type": "Does not like Product"
   }, {
       "type": "Will Decide Later"
   }, {
       "type": "Others"
   }],
   leadCategoryOptions	:	[{
   ...
   "isValidEmail"   :  (email) =>{
      let regExp =  new RegExp("[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$")///^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; 
      console.log("email for verification = ",email,regExp.test(email));
